...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <style>
            body {
                ...
                padding:0;
                overflow:hidden;
                background-image: url('https://visityerevan.am/media/slider/watermarked/fde8a8557cb8ef3809696ee2a935032ac0e5eea3.jpg');
    ...
    <body class="antialiased">
                <section>
                    <div class="relative flex items-top justify-center min-h-screen bgmain  sm:items-center py-4 sm:pt-0">
                        @if (Route::has('login'))
